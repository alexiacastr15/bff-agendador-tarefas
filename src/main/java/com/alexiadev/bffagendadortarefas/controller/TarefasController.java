package com.alexiadev.bffagendadortarefas.controller;

import com.alexiadev.bffagendadortarefas.business.TarefasService;
import com.alexiadev.bffagendadortarefas.business.dto.in.TarefasDTORequest;
import com.alexiadev.bffagendadortarefas.business.dto.out.TarefasDTOResponse;
import com.alexiadev.bffagendadortarefas.business.enums.StatusNotificacaoEnum;
import com.alexiadev.bffagendadortarefas.infrastructure.security.SecurityConfig;
...
@Tag(name = "Tarefas", description = "Cadastro tarefa de usuários")
...
public class TarefasController {
    ...
    @GetMapping("/eventos")
    @Operation(summary = "Busca tarefas de um Período", description = "Busca tarefas cadastradas por período")
    ...
    @GetMapping
    @Operation(summary = "Busca lista tarefas por email de Usuarios", description = "Busca tarefas cadastras por usuário")
    @ApiResponse(responseCode = "200", description = "Tarefa encotradas")
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
    ...
    @PatchMapping
    @Operation(summary = "Altera status de tarefas", description = "Altera status das tarefas")

...
import com.alexiadev.bffagendadortarefas.business.UsuarioService;
...
@Tag(name = "Usuario", description = "Cadastro e login de usuário") //indicar nome e descrição da controller
@SecurityRequirement(name = SecurityConfig.SECURITY_SCHEME)
public class UsuarioController {
    private final UsuarioService usuarioService;

    @PostMapping
    @Operation(summary = "Salvar Usuários", description = "Cria um novo usuário") //descrição do metodo
    @ApiResponse(responseCode = "200", description = "Usuário salvo com sucesso") //indica o status code
    ...
    public ResponseEntity<EnderecoDTOResponse> atualizaEndereco(@RequestBody EnderecoDTORequest dto,
                                                                ...
                                                                @RequestHeader(name = "Authorization", required = false) String token){
        return ResponseEntity.ok(usuarioService.atulizaEndereco(id, dto, token));
    }

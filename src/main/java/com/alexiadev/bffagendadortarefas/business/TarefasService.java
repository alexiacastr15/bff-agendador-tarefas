...
import com.alexiadev.bffagendadortarefas.infrastructure.client.TarefasClient;
...
public class TarefasService {
    ...
    public List<TarefasDTOResponse> buscaTarefaAgendadasPorPeriodo(LocalDateTime dataInicial,
                                                                   ...
                                                                   String token){
        return tarefasClient.buscaListadeTarefasPorPerido(dataInicial, dataFinal, token);
    }
